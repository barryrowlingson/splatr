...
test_that("logLinear",{
  ...
  l6 = logLinear(data,~cows+offset(pigs))
  ...
  l7 = logLinear(data,~cows-1+offset(pigs))
  ...
  l8 = logLinear(data,~offset(pigs))
  expect_equal(l8(1:10,1.2),data$pigs + 1.2)

  l9 = logLinear(data,~offset(pigs)-1)
